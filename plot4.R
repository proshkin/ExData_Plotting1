...
png("plot4.png")
par(mfrow=c(2,2))
plot(dt_c$dt_time, dt_c$Global_active_power, type="l", xlab = "", ylab = "Global Active Power")
plot(dt_c$dt_time, dt_c$Voltage, type="l", xlab = "datetime", ylab = "Voltage")
...
plot(dt_c$dt_time, dt_c$Global_reactive_power, type="l", xlab = "datetime", ylab="Global_reactive_power")
dev.off()